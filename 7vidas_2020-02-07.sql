...
# Database: 7vidas
# Generation Time: 2020-02-07 18:20:59 +0000
# ************************************************************
...
INSERT INTO `cuestionarios` (`id`, `id_cat`, `preguntas`)
VALUES
	(1,5,'{\n  \"Estado\": {\n    \"tipo\": \"text\"\n  },\n  \"Accesorios\": {\n    \"r1\": \"cable usb\",\n    \"r2\": \"cargador original\",\n    \"r3\": \"base para escritorio\",\n    \"type\": \"checkbox\"\n  },\n  \"Tornilleria\": {\n    \"r1\": \"completa\",\n    \"r2\": \"incompleta\",\n    \"type\": \"radio\"\n  }\n}'),
	(2,1,'{\n  \"Color\": {\n    \"type\": \"text\"\n  },\n  \"Smart\": {\n    \"r1\": \"si\",\n    \"r2\": \"no\",\n    \"type\": \"radio\"\n  },\n  \"Accesorios\": {\n    \"r1\": \"cable de corrinte\",\n    \"r2\": \"control remoto\",\n    \"r3\": \"base para pared\",\n    \"type\": \"checkbox\"\n  },\n  \"Pixeles\": {\n    \"r1\": \"ninguno\",\n    \"r2\": \"menos del 10%\",\n    \"r3\": \"mas del 10%\",\n    \"type\": \"radio\"\n  }\n}');
...
CREATE TABLE `factores` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `subcat_id` int(6) DEFAULT NULL,
  `bueno` float DEFAULT NULL,
  `regular` float DEFAULT NULL,
  `malo` float DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `factores` (`id`, `subcat_id`, `bueno`, `regular`, `malo`)
VALUES
	(1,1,29,33,40),
	(2,2,34,43,48.5),
	(3,3,29,33,40),
...
CREATE TABLE `users` (
  ...
  `tienda` int(6) DEFAULT NULL,
  `nivel` int(6) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `tienda`, `nivel`, `password`, `remember_token`, `created_at`, `updated_at`)
VALUES
	(1,'Elvis Presley','elvis@mail.com',NULL,NULL,NULL,'$2y$10$FUZzkSa5YSb5Xn82LaQBs.sxMrCGYUcCZys3BA2deer.i.P362M9u',NULL,'2019-10-22 00:29:44','2019-10-22 00:29:44'),
	(2,'Juan Perez','juan@mail.com',NULL,NULL,NULL,'$2y$10$ekqf6qCZsTkT2k9ah/gjQ.E38i3IuQZkWRJIlodyZtr162X1294HO',NULL,'2019-12-30 21:07:24','2019-12-30 21:07:24');
...
VALUES
	...
	(000031,122,'ThinkCentre','M720',7,18,'2020','1',1,965,2,1,'2020-01-08 01:05:16','2020-01-08 01:05:16'),
	(000032,82,'Moto G 6','32gb',5,13,'2018','1',0,NULL,1,1,'2020-01-10 19:53:39','2020-01-10 19:53:39'),
	(000033,195,'Les Paul','Pelham Blue',14,21,'2020','1',1,NULL,1,1,'2020-01-13 19:38:08','2020-01-13 19:38:08'),
	(000034,123,'macbook','30\"',7,17,'2018','1',0,NULL,1,1,'2020-01-13 20:25:56','2020-01-13 20:25:56'),
	(000035,189,'XAV-AX1000/Q','negro',13,5,'2019','1',1,721,2,1,'2020-01-13 20:27:18','2020-01-13 20:27:18'),
	(000036,60,'6s plus','64gb',5,14,'2018','1',0,5600,2,1,'2020-01-13 21:53:23','2020-01-13 21:53:23'),
	(000037,68,'xt11','blanco',5,13,'2018','1',1,1525,2,1,'2020-01-14 02:32:59','2020-01-14 02:32:59'),
	(000038,21,'KU6000','55\"',1,10,'2019','2',1,5261.5,2,1,'2020-01-27 18:46:44','2020-01-27 18:46:44'),
	(000039,123,'macbook pro','13\"',7,17,'2018','2',0,1500,2,1,'2020-01-29 15:40:35','2020-01-29 15:40:35'),
	(000040,71,'Y7','32 gb',5,13,'2020','2',1,2715,2,1,'2020-02-06 21:08:38','2020-02-06 21:08:38');
